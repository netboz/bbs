...
-type light_component_parameters() ::
    #{entity_id => non_neg_integer(),
      ...
      is_on => boolean() | 0 | 1,
      color => vector_4(),
      diffuse_multiplier => float() | integer() | infinity | '-infinity' | nan,
      specular_multiplier => float() | integer() | infinity | '-infinity' | nan,
      is_ambiant => boolean() | 0 | 1,
      max_point_distance => float() | integer() | infinity | '-infinity' | nan,
      'PointAttenuationBulbSize' => float() | integer() | infinity | '-infinity' | nan,
      area_max_distance => float() | integer() | infinity | '-infinity' | nan,
      area_width => float() | integer() | infinity | '-infinity' | nan,
      area_height => float() | integer() | infinity | '-infinity' | nan,
      area_fov => float() | integer() | infinity | '-infinity' | nan,
      projector_max_distance => float() | integer() | infinity | '-infinity' | nan,
      projector_attenuation_bulb_size => float() | integer() | infinity | '-infinity' | nan,
      projector_fov => float() | integer() | infinity | '-infinity' | nan,
      projector_near_plane => float() | integer() | infinity | '-infinity' | nan,
      probe_area_dimension => vector_3(),
      probe_sort_priority => non_neg_integer(),
      probe_box_projected => boolean() | 0 | 1,
      probe_box_height => float() | integer() | infinity | '-infinity' | nan,
      probe_box_length => float() | integer() | infinity | '-infinity' | nan,
      probe_box_width => float() | integer() | infinity | '-infinity' | nan,
      attenuation_falloff => float() | integer() | infinity | '-infinity' | nan,
      probe_fade => float() | integer() | infinity | '-infinity' | nan}. % = 1, 64 bits
...
-export_type([light_component_parameters/0, m_entity_id/0, generic_result_code/0,
              vector_3/0, vector_4/0]).

-spec encode_msg(light_component_parameters() |
                 m_entity_id() |
                 generic_result_code() |
                 vector_3() |
                 vector_4(),
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        light_component_parameters ->
            encode_msg_light_component_parameters(id(Msg, TrUserData), TrUserData);
        m_entity_id ->
...
encode_msg_light_component_parameters(Msg, TrUserData) ->
    encode_msg_light_component_parameters(Msg, <<>>, TrUserData).
             ...
             #{color := F4} ->
                 begin
                     ...
                     if TrF4 =:= undefined ->
                            B3;
                        true ->
                            e_mfield_light_component_parameters_color(TrF4,
                                                                      <<B3/binary, 34>>,
                                                                      TrUserData)
                     end
                 end;
              ...
              #{area_width := F11} ->
                  begin
                      ...
                      if TrF11 =:= 0.0 ->
                             B10;
                         true ->
                             e_type_float(TrF11, <<B10/binary, 93>>, TrUserData)
                      end
                  end;
              _ ->
                  B10
              ...
              #{area_height := F12} ->
                  begin
                      ...
                      if TrF12 =:= 0.0 ->
                             B11;
                         true ->
                             e_type_float(TrF12, <<B11/binary, 101>>, TrUserData)
                      end
                  end;
              _ ->
                  B11
              ...
              #{area_fov := F13} ->
                  begin
                      ...
                      if TrF13 =:= 0.0 ->
                             B12;
                         true ->
                             e_type_float(TrF13, <<B12/binary, 109>>, TrUserData)
                      end
                  end;
              _ ->
                  B12
              ...
              #{projector_max_distance := F14} ->
                  begin
                      ...
                      if TrF14 =:= 0.0 ->
                             B13;
                         true ->
                             e_type_float(TrF14, <<B13/binary, 117>>, TrUserData)
                      end
                  end;
              _ ->
                  B13
              ...
              #{projector_attenuation_bulb_size := F15} ->
                  begin
                      ...
                      if TrF15 =:= 0.0 ->
                             B14;
                         true ->
                             e_type_float(TrF15, <<B14/binary, 125>>, TrUserData)
                      end
                  end;
              _ ->
                  B14
              ...
              #{projector_fov := F16} ->
                  begin
                      ...
                      if TrF16 =:= 0.0 ->
                             B15;
                         true ->
                             e_type_float(TrF16, <<B15/binary, 133, 1>>, TrUserData)
                      end
                  end;
              _ ->
                  B15
              ...
              #{projector_near_plane := F17} ->
                  begin
                      ...
                      if TrF17 =:= 0.0 ->
                             B16;
                         true ->
                             e_type_float(TrF17, <<B16/binary, 141, 1>>, TrUserData)
                      end
                  end;
              _ ->
                  B16
              ...
              #{probe_area_dimension := F18} ->
                  begin
                      ...
                      if TrF18 =:= undefined ->
                             B17;
                         true ->
                             e_mfield_light_component_parameters_probe_area_dimension(TrF18,
                                                                                      <<B17/binary,
                                                                                        146,
                                                                                        1>>,
                                                                                      TrUserData)
              ...
              #{probe_box_height := F21} ->
                  begin
                      ...
                      if TrF21 =:= 0.0 ->
                             B20;
                         true ->
                             e_type_float(TrF21, <<B20/binary, 173, 1>>, TrUserData)
                      end
                  end;
              _ ->
                  B20
              ...
              #{probe_box_length := F22} ->
                  begin
                      ...
                      if TrF22 =:= 0.0 ->
                             B21;
                         true ->
                             e_type_float(TrF22, <<B21/binary, 181, 1>>, TrUserData)
                      end
                  end;
              _ ->
                  B21
              ...
              #{probe_box_width := F23} ->
                  begin
                      ...
                      if TrF23 =:= 0.0 ->
                             B22;
                         true ->
                             e_type_float(TrF23, <<B22/binary, 189, 1>>, TrUserData)
                      end
                  end;
              _ ->
                  B22
              ...
              #{attenuation_falloff := F24} ->
                  begin
                      ...
                      if TrF24 =:= 0.0 ->
                             B23;
                         true ->
                             e_type_float(TrF24, <<B23/binary, 197, 1>>, TrUserData)
                      end
                  end;
              _ ->
                  B23
        ...
        #{probe_fade := F25} ->
            begin
                ...
                if TrF25 =:= 0.0 ->
                       B24;
                   true ->
                       e_type_float(TrF25, <<B24/binary, 205, 1>>, TrUserData)
                end
            end;
        _ ->
            B24
...
e_mfield_light_component_parameters_color(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_vector_4(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_mfield_light_component_parameters_probe_area_dimension(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_vector_3(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
decode_msg_2_doit(light_component_parameters, Bin, TrUserData) ->
    id(decode_msg_light_component_parameters(Bin, TrUserData), TrUserData);
...
decode_msg_light_component_parameters(Bin, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Bin, 0, 0, id(0, TrUserData),
                                                  id(false, TrUserData), id(false, TrUserData),
                                                  id('$undef', TrUserData), id(0.0, TrUserData),
                                                  id(0.0, TrUserData), id(false, TrUserData),
                                                  ...
                                                  id(false, TrUserData), id(0.0, TrUserData),
                                                  id(0.0, TrUserData), id(0.0, TrUserData),
                                                  id(0.0, TrUserData), id(0.0, TrUserData),
                                                  TrUserData).

dfp_read_field_def_light_component_parameters(<<8, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              ...
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_entity_id(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
...
dfp_read_field_def_light_component_parameters(<<16, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_is_visible(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                  TrUserData);
dfp_read_field_def_light_component_parameters(<<24, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_is_on(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                             F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                             F@_15, F@_16, F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                             F@_23, F@_24, F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<34, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_color(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                             F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                             F@_15, F@_16, F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                             F@_23, F@_24, F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<45, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_diffuse_multiplier(Rest, Z1, Z2, F@_1, F@_2, F@_3,
                                                          F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                                          F@_11, F@_12, F@_13, F@_14, F@_15, F@_16,
                                                          F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                                          F@_23, F@_24, F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<53, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_specular_multiplier(Rest, Z1, Z2, F@_1, F@_2, F@_3,
...
dfp_read_field_def_light_component_parameters(<<56, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_is_ambiant(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                  TrUserData);
dfp_read_field_def_light_component_parameters(<<69, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_max_point_distance(Rest, Z1, Z2, F@_1, F@_2, F@_3,
                                                          F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                                          F@_11, F@_12, F@_13, F@_14, F@_15, F@_16,
                                                          F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                                          F@_23, F@_24, F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<77, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_PointAttenuationBulbSize(Rest, Z1, Z2, F@_1, F@_2,
...
dfp_read_field_def_light_component_parameters(<<85, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_area_max_distance(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                                         F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                         F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                         F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                         F@_24, F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<93, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_area_width(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                  TrUserData);
dfp_read_field_def_light_component_parameters(<<101, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_area_height(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                   F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                   F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                   F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                   TrUserData);
dfp_read_field_def_light_component_parameters(<<109, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_area_fov(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                F@_14, F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                                F@_21, F@_22, F@_23, F@_24, F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<117, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_projector_max_distance(Rest, Z1, Z2, F@_1, F@_2, F@_3,
                                                              F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                                                              F@_10, F@_11, F@_12, F@_13, F@_14,
                                                              F@_15, F@_16, F@_17, F@_18, F@_19,
                                                              F@_20, F@_21, F@_22, F@_23, F@_24,
                                                              F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<125, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_projector_attenuation_bulb_size(Rest, Z1, Z2, F@_1,
                                                                       ...
                                                                       F@_23, F@_24, F@_25,
                                                                       TrUserData);
dfp_read_field_def_light_component_parameters(<<133, 1, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_projector_fov(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                                     F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                     F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                     F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                     F@_24, F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<141, 1, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_projector_near_plane(Rest, Z1, Z2, F@_1, F@_2, F@_3,
                                                            F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                                                            F@_10, F@_11, F@_12, F@_13, F@_14,
                                                            F@_15, F@_16, F@_17, F@_18, F@_19,
                                                            F@_20, F@_21, F@_22, F@_23, F@_24,
                                                            F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<146, 1, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_probe_area_dimension(Rest, Z1, Z2, F@_1, F@_2, F@_3,
                                                            F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                                                            F@_10, F@_11, F@_12, F@_13, F@_14,
                                                            F@_15, F@_16, F@_17, F@_18, F@_19,
                                                            F@_20, F@_21, F@_22, F@_23, F@_24,
                                                            F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<152, 1, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_probe_sort_priority(Rest, Z1, Z2, F@_1, F@_2, F@_3,
                                                           F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                                                           F@_10, F@_11, F@_12, F@_13, F@_14, F@_15,
                                                           F@_16, F@_17, F@_18, F@_19, F@_20, F@_21,
                                                           F@_22, F@_23, F@_24, F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<160, 1, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_probe_box_projected(Rest, Z1, Z2, F@_1, F@_2, F@_3,
                                                           F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                                                           F@_10, F@_11, F@_12, F@_13, F@_14, F@_15,
                                                           F@_16, F@_17, F@_18, F@_19, F@_20, F@_21,
                                                           F@_22, F@_23, F@_24, F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<173, 1, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_probe_box_height(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                                        F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                        F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                        F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                        F@_24, F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<181, 1, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_probe_box_length(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                                        F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                        F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                        F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                        F@_24, F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<189, 1, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_probe_box_width(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                                       F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                       F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                       F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                       F@_24, F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<197, 1, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_attenuation_falloff(Rest, Z1, Z2, F@_1, F@_2, F@_3,
                                                           F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                                                           F@_10, F@_11, F@_12, F@_13, F@_14, F@_15,
                                                           F@_16, F@_17, F@_18, F@_19, F@_20, F@_21,
                                                           F@_22, F@_23, F@_24, F@_25, TrUserData);
dfp_read_field_def_light_component_parameters(<<205, 1, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    d_field_light_component_parameters_probe_fade(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                  TrUserData);
dfp_read_field_def_light_component_parameters(<<>>, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                              F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                              F@_14, F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                              F@_21, F@_22, F@_23, F@_24, F@_25, _) ->
    S1 = #{entity_id => F@_1,
           is_visible => F@_2,
           is_on => F@_3,
           diffuse_multiplier => F@_5,
           specular_multiplier => F@_6,
           is_ambiant => F@_7,
           max_point_distance => F@_8,
           'PointAttenuationBulbSize' => F@_9,
           area_max_distance => F@_10,
           area_width => F@_11,
           area_height => F@_12,
           area_fov => F@_13,
           projector_max_distance => F@_14,
           projector_attenuation_bulb_size => F@_15,
           projector_fov => F@_16,
           projector_near_plane => F@_17,
           probe_sort_priority => F@_19,
           probe_box_projected => F@_20,
           probe_box_height => F@_21,
           probe_box_length => F@_22,
           probe_box_width => F@_23,
           attenuation_falloff => F@_24,
           probe_fade => F@_25},
    S2 = if F@_4 == '$undef' ->
                S1;
            true ->
    ...
    if F@_18 == '$undef' ->
           S2;
       true ->
           S2#{probe_area_dimension => F@_18}
    end;
dfp_read_field_def_light_component_parameters(Other, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                              F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                              F@_14, F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                              F@_21, F@_22, F@_23, F@_24, F@_25, TrUserData) ->
    dg_read_field_def_light_component_parameters(Other, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                 F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                 F@_14, F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                                 F@_21, F@_22, F@_23, F@_24, F@_25, TrUserData).

dg_read_field_def_light_component_parameters(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1,
                                             ...
                                             TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_light_component_parameters(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, F@_3,
                                                 F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                 F@_12, F@_13, F@_14, F@_15, F@_16, F@_17, F@_18,
                                                 F@_19, F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                 TrUserData);
dg_read_field_def_light_component_parameters(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1,
                                             F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                             F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17, F@_18,
                                             F@_19, F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                             TrUserData) ->
    ...
    case Key of
        8 ->
            d_field_light_component_parameters_entity_id(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                         F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                         F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                         F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                         F@_24, F@_25, TrUserData);
        16 ->
            d_field_light_component_parameters_is_visible(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                          F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                          F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                          F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                          F@_24, F@_25, TrUserData);
        24 ->
            d_field_light_component_parameters_is_on(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                                     F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                     F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                     F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                     TrUserData);
        34 ->
            d_field_light_component_parameters_color(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                                     F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                     F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                     F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                     TrUserData);
        45 ->
            d_field_light_component_parameters_diffuse_multiplier(Rest, 0, 0, F@_1, F@_2, F@_3,
                                                                  ...
                                                                  F@_24, F@_25, TrUserData);
        53 ->
            d_field_light_component_parameters_specular_multiplier(Rest, 0, 0, F@_1, F@_2, F@_3,
                                                                   F@_4, F@_5, F@_6, F@_7, F@_8,
                                                                   F@_9, F@_10, F@_11, F@_12, F@_13,
                                                                   ...
                                                                   TrUserData);
        56 ->
            d_field_light_component_parameters_is_ambiant(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                          F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                          F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                          F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                          F@_24, F@_25, TrUserData);
        69 ->
            d_field_light_component_parameters_max_point_distance(Rest, 0, 0, F@_1, F@_2, F@_3,
                                                                  F@_4, F@_5, F@_6, F@_7, F@_8,
                                                                  F@_9, F@_10, F@_11, F@_12, F@_13,
                                                                  F@_14, F@_15, F@_16, F@_17, F@_18,
                                                                  F@_19, F@_20, F@_21, F@_22, F@_23,
                                                                  F@_24, F@_25, TrUserData);
        77 ->
            d_field_light_component_parameters_PointAttenuationBulbSize(Rest, 0, 0, F@_1, F@_2,
                                                                        F@_3, F@_4, F@_5, F@_6,
                                                                        F@_7, F@_8, F@_9, F@_10,
                                                                        F@_11, F@_12, F@_13, F@_14,
                                                                        F@_15, F@_16, F@_17, F@_18,
                                                                        ...
                                                                        TrUserData);
        85 ->
            d_field_light_component_parameters_area_max_distance(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
                                                                 ...
                                                                 F@_25, TrUserData);
        93 ->
            d_field_light_component_parameters_area_width(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                          F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                          F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                          F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                          F@_24, F@_25, TrUserData);
        101 ->
            d_field_light_component_parameters_area_height(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                           F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                           F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                           F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                           F@_24, F@_25, TrUserData);
        109 ->
            d_field_light_component_parameters_area_fov(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                        F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                        F@_13, F@_14, F@_15, F@_16, F@_17, F@_18,
                                                        F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                        F@_25, TrUserData);
        117 ->
            d_field_light_component_parameters_projector_max_distance(Rest, 0, 0, F@_1, F@_2, F@_3,
                                                                      F@_4, F@_5, F@_6, F@_7, F@_8,
                                                                      ...
                                                                      F@_25, TrUserData);
        125 ->
            d_field_light_component_parameters_projector_attenuation_bulb_size(Rest, 0, 0, F@_1,
                                                                               F@_2, F@_3, F@_4,
                                                                               F@_5, F@_6, F@_7,
                                                                               F@_8, F@_9, F@_10,
                                                                               F@_11, F@_12, F@_13,
                                                                               ...
                                                                               TrUserData);
        133 ->
            d_field_light_component_parameters_projector_fov(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
                                                             ...
                                                             TrUserData);
        141 ->
            d_field_light_component_parameters_projector_near_plane(Rest, 0, 0, F@_1, F@_2, F@_3,
                                                                    F@_4, F@_5, F@_6, F@_7, F@_8,
                                                                    F@_9, F@_10, F@_11, F@_12,
                                                                    F@_13, F@_14, F@_15, F@_16,
                                                                    F@_17, F@_18, F@_19, F@_20,
                                                                    ...
                                                                    F@_25, TrUserData);
        146 ->
            d_field_light_component_parameters_probe_area_dimension(Rest, 0, 0, F@_1, F@_2, F@_3,
                                                                    F@_4, F@_5, F@_6, F@_7, F@_8,
                                                                    F@_9, F@_10, F@_11, F@_12,
                                                                    F@_13, F@_14, F@_15, F@_16,
                                                                    F@_17, F@_18, F@_19, F@_20,
                                                                    ...
                                                                    F@_25, TrUserData);
        152 ->
            d_field_light_component_parameters_probe_sort_priority(Rest, 0, 0, F@_1, F@_2, F@_3,
                                                                   F@_4, F@_5, F@_6, F@_7, F@_8,
                                                                   F@_9, F@_10, F@_11, F@_12, F@_13,
                                                                   F@_14, F@_15, F@_16, F@_17,
                                                                   F@_18, F@_19, F@_20, F@_21,
                                                                   ...
                                                                   TrUserData);
        160 ->
            d_field_light_component_parameters_probe_box_projected(Rest, 0, 0, F@_1, F@_2, F@_3,
                                                                   F@_4, F@_5, F@_6, F@_7, F@_8,
                                                                   F@_9, F@_10, F@_11, F@_12, F@_13,
                                                                   F@_14, F@_15, F@_16, F@_17,
                                                                   F@_18, F@_19, F@_20, F@_21,
                                                                   ...
                                                                   TrUserData);
        173 ->
            d_field_light_component_parameters_probe_box_height(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
                                                                F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                                                F@_11, F@_12, F@_13, F@_14, F@_15,
                                                                F@_16, F@_17, F@_18, F@_19, F@_20,
                                                                F@_21, F@_22, F@_23, F@_24, F@_25,
                                                                TrUserData);
        181 ->
            d_field_light_component_parameters_probe_box_length(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
                                                                F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                                                F@_11, F@_12, F@_13, F@_14, F@_15,
                                                                F@_16, F@_17, F@_18, F@_19, F@_20,
                                                                F@_21, F@_22, F@_23, F@_24, F@_25,
                                                                TrUserData);
        189 ->
            d_field_light_component_parameters_probe_box_width(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4,
                                                               F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                                               F@_11, F@_12, F@_13, F@_14, F@_15,
                                                               F@_16, F@_17, F@_18, F@_19, F@_20,
                                                               F@_21, F@_22, F@_23, F@_24, F@_25,
                                                               TrUserData);
        197 ->
            d_field_light_component_parameters_attenuation_falloff(Rest, 0, 0, F@_1, F@_2, F@_3,
                                                                   F@_4, F@_5, F@_6, F@_7, F@_8,
                                                                   F@_9, F@_10, F@_11, F@_12, F@_13,
                                                                   F@_14, F@_15, F@_16, F@_17,
                                                                   F@_18, F@_19, F@_20, F@_21,
                                                                   ...
                                                                   TrUserData);
        205 ->
            d_field_light_component_parameters_probe_fade(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                          F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                          F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                          F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                          F@_24, F@_25, TrUserData);
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_light_component_parameters(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                           F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                           F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                           F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                           F@_24, F@_25, TrUserData);
                1 ->
                    skip_64_light_component_parameters(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                       F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                       F@_13, F@_14, F@_15, F@_16, F@_17, F@_18,
                                                       F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                       F@_25, TrUserData);
                2 ->
                    skip_length_delimited_light_component_parameters(Rest, 0, 0, F@_1, F@_2, F@_3,
                                                                     F@_4, F@_5, F@_6, F@_7, F@_8,
                                                                     F@_9, F@_10, F@_11, F@_12,
                                                                     F@_13, F@_14, F@_15, F@_16,
                                                                     F@_17, F@_18, F@_19, F@_20,
                                                                     ...
                                                                     F@_25, TrUserData);
                3 ->
                    skip_group_light_component_parameters(Rest, Key bsr 3, 0, F@_1, F@_2, F@_3,
                                                          F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                                          F@_11, F@_12, F@_13, F@_14, F@_15, F@_16,
                                                          F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                                          F@_23, F@_24, F@_25, TrUserData);
                5 ->
                    skip_32_light_component_parameters(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                       F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                       F@_13, F@_14, F@_15, F@_16, F@_17, F@_18,
                                                       F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                       F@_25, TrUserData)
...
dg_read_field_def_light_component_parameters(<<>>, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                             F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
...
d_field_light_component_parameters_entity_id(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1,
                                             F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                             F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17, F@_18,
                                             F@_19, F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                             TrUserData)
    when N < 57 ->
    d_field_light_component_parameters_entity_id(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, F@_3,
                                                 F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                 F@_12, F@_13, F@_14, F@_15, F@_16, F@_17, F@_18,
                                                 F@_19, F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                 TrUserData);
d_field_light_component_parameters_entity_id(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_2,
    ...
    dfp_read_field_def_light_component_parameters(RestF, 0, 0, NewFValue, F@_2, F@_3, F@_4,
                                                  F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                  TrUserData).

d_field_light_component_parameters_is_visible(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1,
                                              F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData)
    when N < 57 ->
    d_field_light_component_parameters_is_visible(Rest, N + 7, X bsl N + Acc, F@_1, F@_2,
                                                  F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                                  F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_is_visible(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, _,
                                              F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0, TrUserData), Rest},
    dfp_read_field_def_light_component_parameters(RestF, 0, 0, F@_1, NewFValue, F@_3, F@_4,
                                                  F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                  TrUserData).

d_field_light_component_parameters_is_on(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2,
                                         F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                         F@_12, F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                         F@_20, F@_21, F@_22, F@_23, F@_24, F@_25, TrUserData)
    when N < 57 ->
    d_field_light_component_parameters_is_on(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, F@_3,
                                             F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                             F@_12, F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                             F@_20, F@_21, F@_22, F@_23, F@_24, F@_25, TrUserData);
d_field_light_component_parameters_is_on(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, _,
                                         F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                         F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                         F@_21, F@_22, F@_23, F@_24, F@_25, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0, TrUserData), Rest},
    dfp_read_field_def_light_component_parameters(RestF, 0, 0, F@_1, F@_2, NewFValue, F@_4,
                                                  F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                  TrUserData).

d_field_light_component_parameters_color(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2,
                                         F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                         F@_12, F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                         F@_20, F@_21, F@_22, F@_23, F@_24, F@_25, TrUserData)
    when N < 57 ->
    d_field_light_component_parameters_color(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, F@_3,
                                             F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                             F@_12, F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                             F@_20, F@_21, F@_22, F@_23, F@_24, F@_25, TrUserData);
d_field_light_component_parameters_color(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2,
                                         F@_3, Prev, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                         F@_12, F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                         F@_20, F@_21, F@_22, F@_23, F@_24, F@_25, TrUserData) ->
    {NewFValue, RestF} =
        begin
            ...
            {id(decode_msg_vector_4(Bs, TrUserData), TrUserData), Rest2}
        end,
    dfp_read_field_def_light_component_parameters(RestF, 0, 0, F@_1, F@_2, F@_3,
                                                  if Prev == '$undef' ->
                                                         NewFValue;
                                                     true ->
                                                         merge_msg_vector_4(Prev,
                                                                            NewFValue,
                                                                            TrUserData)
                                                  end,
                                                  F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
...
d_field_light_component_parameters_diffuse_multiplier(<<0:16, 128, 127, Rest/binary>>, Z1,
                                                      Z2, F@_1, F@_2, F@_3, F@_4, _, F@_6, F@_7,
                                                      F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                      F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                                      F@_21, F@_22, F@_23, F@_24, F@_25,
                                                      TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                                  id(infinity, TrUserData), F@_6, F@_7, F@_8, F@_9,
                                                  F@_10, F@_11, F@_12, F@_13, F@_14, F@_15, F@_16,
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_diffuse_multiplier(<<0:16, 128, 255, Rest/binary>>, Z1,
                                                      Z2, F@_1, F@_2, F@_3, F@_4, _, F@_6, F@_7,
                                                      F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                      F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                                      F@_21, F@_22, F@_23, F@_24, F@_25,
                                                      TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                                  id('-infinity', TrUserData), F@_6, F@_7, F@_8,
                                                  F@_9, F@_10, F@_11, F@_12, F@_13, F@_14, F@_15,
                                                  F@_16, F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                                  F@_23, F@_24, F@_25, TrUserData);
d_field_light_component_parameters_diffuse_multiplier(<<_:16,
                                                        1:1,
                                                        _:7,
                                                        _:1,
                                                        127:7,
                                                      ...
                                                      TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                                  id(nan, TrUserData), F@_6, F@_7, F@_8, F@_9,
                                                  F@_10, F@_11, F@_12, F@_13, F@_14, F@_15, F@_16,
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_diffuse_multiplier(<<Value:32/little-float,
                                                        Rest/binary>>,
                                                      Z1, Z2, F@_1, F@_2, F@_3, F@_4, _, F@_6, F@_7,
                                                      F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                      F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                                      ...
                                                      TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                                  id(Value, TrUserData), F@_6, F@_7, F@_8, F@_9,
                                                  F@_10, F@_11, F@_12, F@_13, F@_14, F@_15, F@_16,
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData).

d_field_light_component_parameters_specular_multiplier(<<0:16, 128, 127, Rest/binary>>,
                                                       Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, _,
                                                       F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                       F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                       F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                       TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  id(infinity, TrUserData), F@_7, F@_8, F@_9, F@_10,
                                                  F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_specular_multiplier(<<0:16, 128, 255, Rest/binary>>,
                                                       Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, _,
                                                       F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                       F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                       F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                       TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  id('-infinity', TrUserData), F@_7, F@_8, F@_9,
                                                  F@_10, F@_11, F@_12, F@_13, F@_14, F@_15, F@_16,
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_specular_multiplier(<<_:16,
                                                         1:1,
                                                         _:7,
                                                         _:1,
                                                         127:7,
                                                       ...
                                                       TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  id(nan, TrUserData), F@_7, F@_8, F@_9, F@_10,
                                                  F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_specular_multiplier(<<Value:32/little-float,
                                                         Rest/binary>>,
                                                       Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, _,
                                                       F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                       F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                       ...
                                                       TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  id(Value, TrUserData), F@_7, F@_8, F@_9, F@_10,
                                                  F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData).

d_field_light_component_parameters_is_ambiant(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1,
                                              F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData)
    when N < 57 ->
    d_field_light_component_parameters_is_ambiant(Rest, N + 7, X bsl N + Acc, F@_1, F@_2,
                                                  F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                                  F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_is_ambiant(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1,
                                              F@_2, F@_3, F@_4, F@_5, F@_6, _, F@_8, F@_9, F@_10,
                                              F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0, TrUserData), Rest},
    dfp_read_field_def_light_component_parameters(RestF, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, NewFValue, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                  TrUserData).

d_field_light_component_parameters_max_point_distance(<<0:16, 128, 127, Rest/binary>>, Z1,
                                                      ...
                                                      TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, id(infinity, TrUserData), F@_9, F@_10,
                                                  F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_max_point_distance(<<0:16, 128, 255, Rest/binary>>, Z1,
                                                      Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                      _, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                      F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                                      F@_21, F@_22, F@_23, F@_24, F@_25,
                                                      TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, id('-infinity', TrUserData), F@_9,
                                                  F@_10, F@_11, F@_12, F@_13, F@_14, F@_15, F@_16,
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_max_point_distance(<<_:16,
                                                        1:1,
                                                        _:7,
                                                        _:1,
                                                        127:7,
                                                      ...
                                                      TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, id(nan, TrUserData), F@_9, F@_10,
                                                  F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_max_point_distance(<<Value:32/little-float,
                                                        Rest/binary>>,
                                                      Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                                      F@_7, _, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                      F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                      ...
                                                      TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, id(Value, TrUserData), F@_9, F@_10,
                                                  F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData).

d_field_light_component_parameters_PointAttenuationBulbSize(<<0:16,
                                                              128,
                                                              127,
                                                              Rest/binary>>,
                                                            ...
                                                            TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, id(infinity, TrUserData), F@_10,
                                                  F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_PointAttenuationBulbSize(<<0:16,
                                                            ...
                                                            TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, id('-infinity', TrUserData),
                                                  F@_10, F@_11, F@_12, F@_13, F@_14, F@_15, F@_16,
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_PointAttenuationBulbSize(<<_:16,
                                                              1:1,
                                                              _:7,
                                                              _:1,
                                                              127:7,
                                                            ...
                                                            TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, id(nan, TrUserData), F@_10,
                                                  F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_PointAttenuationBulbSize(<<Value:32/little-float,
                                                              Rest/binary>>,
                                                            Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                            F@_6, F@_7, F@_8, _, F@_10, F@_11,
                                                            F@_12, F@_13, F@_14, F@_15, F@_16,
                                                            ...
                                                            TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, id(Value, TrUserData), F@_10,
                                                  F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData).

d_field_light_component_parameters_area_max_distance(<<0:16, 128, 127, Rest/binary>>, Z1,
                                                     Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                     ...
                                                     TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, id(infinity, TrUserData),
                                                  F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_area_max_distance(<<0:16, 128, 255, Rest/binary>>, Z1,
                                                     Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                     F@_8, F@_9, _, F@_11, F@_12, F@_13, F@_14,
                                                     F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                                     F@_21, F@_22, F@_23, F@_24, F@_25,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  ...
                                                  F@_14, F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                                  F@_21, F@_22, F@_23, F@_24, F@_25, TrUserData);
d_field_light_component_parameters_area_max_distance(<<_:16,
                                                       1:1,
                                                       _:7,
                                                       _:1,
                                                       127:7,
                                                     ...
                                                     TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, id(nan, TrUserData),
                                                  F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_area_max_distance(<<Value:32/little-float,
                                                       Rest/binary>>,
                                                     Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                                     F@_7, F@_8, F@_9, _, F@_11, F@_12, F@_13,
                                                     F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                     ...
                                                     TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, id(Value, TrUserData),
                                                  F@_11, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData).

d_field_light_component_parameters_area_width(<<0:16, 128, 127, Rest/binary>>, Z1, Z2,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  ...
                                                  id(infinity, TrUserData), F@_12, F@_13, F@_14,
                                                  F@_15, F@_16, F@_17, F@_18, F@_19, F@_20, F@_21,
                                                  F@_22, F@_23, F@_24, F@_25, TrUserData);
d_field_light_component_parameters_area_width(<<0:16, 128, 255, Rest/binary>>, Z1, Z2,
                                              F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                                              F@_10, _, F@_12, F@_13, F@_14, F@_15, F@_16, F@_17,
                                              F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                              F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  ...
                                                  F@_15, F@_16, F@_17, F@_18, F@_19, F@_20, F@_21,
                                                  F@_22, F@_23, F@_24, F@_25, TrUserData);
d_field_light_component_parameters_area_width(<<_:16, 1:1, _:7, _:1, 127:7, Rest/binary>>,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10,
                                                  id(nan, TrUserData), F@_12, F@_13, F@_14, F@_15,
                                                  F@_16, F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                                  F@_23, F@_24, F@_25, TrUserData);
d_field_light_component_parameters_area_width(<<Value:32/little-float, Rest/binary>>, Z1,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10,
                                                  id(Value, TrUserData), F@_12, F@_13, F@_14, F@_15,
                                                  F@_16, F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                                  F@_23, F@_24, F@_25, TrUserData).

d_field_light_component_parameters_area_height(<<0:16, 128, 127, Rest/binary>>, Z1, Z2,
                                               F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                                               F@_10, F@_11, _, F@_13, F@_14, F@_15, F@_16, F@_17,
                                               F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                               F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                  id(infinity, TrUserData), F@_13, F@_14, F@_15,
                                                  F@_16, F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                                  F@_23, F@_24, F@_25, TrUserData);
d_field_light_component_parameters_area_height(<<0:16, 128, 255, Rest/binary>>, Z1, Z2,
                                               F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                                               F@_10, F@_11, _, F@_13, F@_14, F@_15, F@_16, F@_17,
                                               F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                               F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  ...
                                                  F@_16, F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                                  F@_23, F@_24, F@_25, TrUserData);
d_field_light_component_parameters_area_height(<<_:16,
                                                 1:1,
                                                 _:7,
                                                 _:1,
                                                 127:7,
                                                 Rest/binary>>,
                                               Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                               F@_8, F@_9, F@_10, F@_11, _, F@_13, F@_14, F@_15,
                                               F@_16, F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                               F@_23, F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                  id(nan, TrUserData), F@_13, F@_14, F@_15, F@_16,
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_area_height(<<Value:32/little-float, Rest/binary>>, Z1,
                                               Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                  id(Value, TrUserData), F@_13, F@_14, F@_15, F@_16,
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData).

d_field_light_component_parameters_area_fov(<<0:16, 128, 127, Rest/binary>>, Z1, Z2, F@_1,
                                            F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                            F@_11, F@_12, _, F@_14, F@_15, F@_16, F@_17, F@_18,
                                            F@_19, F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                            TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  id(infinity, TrUserData), F@_14, F@_15, F@_16,
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_area_fov(<<0:16, 128, 255, Rest/binary>>, Z1, Z2, F@_1,
                                            F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
                                            F@_11, F@_12, _, F@_14, F@_15, F@_16, F@_17, F@_18,
                                            F@_19, F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                            TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  ...
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_area_fov(<<_:16, 1:1, _:7, _:1, 127:7, Rest/binary>>,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  id(nan, TrUserData), F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_area_fov(<<Value:32/little-float, Rest/binary>>, Z1,
                                            Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
                                            F@_9, F@_10, F@_11, F@_12, _, F@_14, F@_15, F@_16,
                                            F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                            F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  id(Value, TrUserData), F@_14, F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData).

d_field_light_component_parameters_projector_max_distance(<<0:16, 128, 127, Rest/binary>>,
                                                          Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                          F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, id(infinity, TrUserData), F@_15, F@_16,
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_projector_max_distance(<<0:16, 128, 255, Rest/binary>>,
                                                          Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                          F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                          F@_12, F@_13, _, F@_15, F@_16, F@_17,
                                                          F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  ...
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_projector_max_distance(<<_:16,
                                                            1:1,
                                                            _:7,
                                                            _:1,
                                                            127:7,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, id(nan, TrUserData), F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_projector_max_distance(<<Value:32/little-float,
                                                            Rest/binary>>,
                                                          Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                          F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                                          F@_12, F@_13, _, F@_15, F@_16, F@_17,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, id(Value, TrUserData), F@_15, F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData).

d_field_light_component_parameters_projector_attenuation_bulb_size(<<0:16,
                                                                     128,
                                                                     127,
                                                                     Rest/binary>>,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, id(infinity, TrUserData), F@_16,
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_projector_attenuation_bulb_size(<<0:16,
                                                                     128,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  ...
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_projector_attenuation_bulb_size(<<_:16,
                                                                     1:1,
                                                                     _:7,
                                                                     _:1,
                                                                     127:7,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, id(nan, TrUserData), F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_projector_attenuation_bulb_size(<<Value:32/little-float,
                                                                     Rest/binary>>,
                                                                   Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                                                   F@_5, F@_6, F@_7, F@_8, F@_9,
                                                                   F@_10, F@_11, F@_12, F@_13,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, id(Value, TrUserData), F@_16, F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData).

d_field_light_component_parameters_projector_fov(<<0:16, 128, 127, Rest/binary>>, Z1, Z2,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, id(infinity, TrUserData),
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_projector_fov(<<0:16, 128, 255, Rest/binary>>, Z1, Z2,
                                                 F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
                                                 F@_9, F@_10, F@_11, F@_12, F@_13, F@_14, F@_15, _,
                                                 F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                 F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  ...
                                                  F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_projector_fov(<<_:16,
                                                   1:1,
                                                   _:7,
                                                   _:1,
                                                   127:7,
                                                 ...
                                                 Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                 F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                 F@_15, _, F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                                 F@_23, F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, id(nan, TrUserData), F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_projector_fov(<<Value:32/little-float, Rest/binary>>,
                                                 Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                 F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                 F@_15, _, F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                                 F@_23, F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, id(Value, TrUserData), F@_17,
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData).

d_field_light_component_parameters_projector_near_plane(<<0:16, 128, 127, Rest/binary>>,
                                                        Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                                        F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                        F@_13, F@_14, F@_15, F@_16, _, F@_18, F@_19,
                                                        F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                        TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16,
                                                  id(infinity, TrUserData), F@_18, F@_19, F@_20,
                                                  F@_21, F@_22, F@_23, F@_24, F@_25, TrUserData);
d_field_light_component_parameters_projector_near_plane(<<0:16, 128, 255, Rest/binary>>,
                                                        Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                                        F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                        F@_13, F@_14, F@_15, F@_16, _, F@_18, F@_19,
                                                        F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  ...
                                                  id('-infinity', TrUserData), F@_18, F@_19, F@_20,
                                                  F@_21, F@_22, F@_23, F@_24, F@_25, TrUserData);
d_field_light_component_parameters_projector_near_plane(<<_:16,
                                                          1:1,
                                                          _:7,
                                                          _:1,
                                                          127:7,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, id(nan, TrUserData),
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_projector_near_plane(<<Value:32/little-float,
                                                          Rest/binary>>,
                                                        Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                                        F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                        F@_13, F@_14, F@_15, F@_16, _, F@_18, F@_19,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, id(Value, TrUserData),
                                                  F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData).

d_field_light_component_parameters_probe_area_dimension(<<1:1, X:7, Rest/binary>>, N, Acc,
                                                        ...
                                                        TrUserData)
    when N < 57 ->
    d_field_light_component_parameters_probe_area_dimension(Rest, N + 7, X bsl N + Acc, F@_1,
                                                            F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                            F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                            F@_14, F@_15, F@_16, F@_17, F@_18,
                                                            F@_19, F@_20, F@_21, F@_22, F@_23,
                                                            F@_24, F@_25, TrUserData);
d_field_light_component_parameters_probe_area_dimension(<<0:1, X:7, Rest/binary>>, N, Acc,
                                                        F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                        F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                        F@_14, F@_15, F@_16, F@_17, Prev, F@_19,
                                                        F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                        TrUserData) ->
    {NewFValue, RestF} =
        begin
            Len = X bsl N + Acc,
            <<Bs:Len/binary, Rest2/binary>> = Rest,
            {id(decode_msg_vector_3(Bs, TrUserData), TrUserData), Rest2}
        end,
    dfp_read_field_def_light_component_parameters(RestF, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
...
d_field_light_component_parameters_probe_sort_priority(<<1:1, X:7, Rest/binary>>, N, Acc,
                                                       F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                       F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                       F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                       F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                       TrUserData)
    when N < 57 ->
    d_field_light_component_parameters_probe_sort_priority(Rest, N + 7, X bsl N + Acc, F@_1,
                                                           F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
                                                           F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                           F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                                           F@_21, F@_22, F@_23, F@_24, F@_25,
                                                           TrUserData);
d_field_light_component_parameters_probe_sort_priority(<<0:1, X:7, Rest/binary>>, N, Acc,
                                                       F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                       F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                       F@_14, F@_15, F@_16, F@_17, F@_18, _, F@_20,
                                                       F@_21, F@_22, F@_23, F@_24, F@_25,
                                                       TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData), Rest},
    dfp_read_field_def_light_component_parameters(RestF, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
...
d_field_light_component_parameters_probe_box_projected(<<1:1, X:7, Rest/binary>>, N, Acc,
                                                       F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                       F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                       F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                       F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                       TrUserData)
    when N < 57 ->
    d_field_light_component_parameters_probe_box_projected(Rest, N + 7, X bsl N + Acc, F@_1,
                                                           F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
                                                           F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                           F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                                           F@_21, F@_22, F@_23, F@_24, F@_25,
                                                           TrUserData);
d_field_light_component_parameters_probe_box_projected(<<0:1, X:7, Rest/binary>>, N, Acc,
                                                       F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                       F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                       F@_14, F@_15, F@_16, F@_17, F@_18, F@_19, _,
                                                       F@_21, F@_22, F@_23, F@_24, F@_25,
                                                       TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0, TrUserData), Rest},
    dfp_read_field_def_light_component_parameters(RestF, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  NewFValue, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                  TrUserData).

d_field_light_component_parameters_probe_box_height(<<0:16, 128, 127, Rest/binary>>, Z1,
                                                    Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                    F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                    F@_15, F@_16, F@_17, F@_18, F@_19, F@_20, _,
                                                    F@_22, F@_23, F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, id(infinity, TrUserData), F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_probe_box_height(<<0:16, 128, 255, Rest/binary>>, Z1,
                                                    Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                    F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                    F@_15, F@_16, F@_17, F@_18, F@_19, F@_20, _,
                                                    F@_22, F@_23, F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  ...
                                                  F@_20, id('-infinity', TrUserData), F@_22, F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_probe_box_height(<<_:16,
                                                      1:1,
                                                      _:7,
                                                      _:1,
                                                      127:7,
                                                    ...
                                                    F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                    F@_14, F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                                    _, F@_22, F@_23, F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, id(nan, TrUserData), F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_probe_box_height(<<Value:32/little-float,
                                                      Rest/binary>>,
                                                    Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                                    F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                    F@_14, F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, id(Value, TrUserData), F@_22, F@_23, F@_24,
                                                  F@_25, TrUserData).

d_field_light_component_parameters_probe_box_length(<<0:16, 128, 127, Rest/binary>>, Z1,
                                                    Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                    F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                    F@_15, F@_16, F@_17, F@_18, F@_19, F@_20, F@_21,
                                                    _, F@_23, F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, id(infinity, TrUserData), F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_probe_box_length(<<0:16, 128, 255, Rest/binary>>, Z1,
                                                    Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                    F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                    F@_15, F@_16, F@_17, F@_18, F@_19, F@_20, F@_21,
                                                    _, F@_23, F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  ...
                                                  F@_20, F@_21, id('-infinity', TrUserData), F@_23,
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_probe_box_length(<<_:16,
                                                      1:1,
                                                      _:7,
                                                      _:1,
                                                      127:7,
                                                    ...
                                                    F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                    F@_14, F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
                                                    F@_21, _, F@_23, F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, id(nan, TrUserData), F@_23, F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_probe_box_length(<<Value:32/little-float,
                                                      Rest/binary>>,
                                                    Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                                    F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                    F@_14, F@_15, F@_16, F@_17, F@_18, F@_19, F@_20,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, id(Value, TrUserData), F@_23, F@_24,
                                                  F@_25, TrUserData).

d_field_light_component_parameters_probe_box_width(<<0:16, 128, 127, Rest/binary>>, Z1,
                                                   Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                   F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                   F@_15, F@_16, F@_17, F@_18, F@_19, F@_20, F@_21,
                                                   F@_22, _, F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, id(infinity, TrUserData),
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_probe_box_width(<<0:16, 128, 255, Rest/binary>>, Z1,
                                                   Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                   F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                   F@_15, F@_16, F@_17, F@_18, F@_19, F@_20, F@_21,
                                                   F@_22, _, F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  ...
                                                  F@_20, F@_21, F@_22, id('-infinity', TrUserData),
                                                  F@_24, F@_25, TrUserData);
d_field_light_component_parameters_probe_box_width(<<_:16,
                                                     1:1,
                                                     _:7,
                                                     _:1,
                                                     127:7,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, id(nan, TrUserData), F@_24,
                                                  F@_25, TrUserData);
d_field_light_component_parameters_probe_box_width(<<Value:32/little-float, Rest/binary>>,
                                                   Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                                   F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                                   F@_15, F@_16, F@_17, F@_18, F@_19, F@_20, F@_21,
                                                   F@_22, _, F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, id(Value, TrUserData), F@_24,
                                                  F@_25, TrUserData).

d_field_light_component_parameters_attenuation_falloff(<<0:16, 128, 127, Rest/binary>>,
                                                       Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                                       F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                       F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                       F@_20, F@_21, F@_22, F@_23, _, F@_25,
                                                       TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, F@_23,
                                                  id(infinity, TrUserData), F@_25, TrUserData);
d_field_light_component_parameters_attenuation_falloff(<<0:16, 128, 255, Rest/binary>>,
                                                       Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                                       F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                       F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                       F@_20, F@_21, F@_22, F@_23, _, F@_25,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  ...
                                                  F@_20, F@_21, F@_22, F@_23,
                                                  id('-infinity', TrUserData), F@_25, TrUserData);
d_field_light_component_parameters_attenuation_falloff(<<_:16,
                                                         1:1,
                                                         _:7,
                                                         _:1,
                                                         127:7,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, F@_23, id(nan, TrUserData),
                                                  F@_25, TrUserData);
d_field_light_component_parameters_attenuation_falloff(<<Value:32/little-float,
                                                         Rest/binary>>,
                                                       Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                                       F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
                                                       F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
    ...
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, F@_23, id(Value, TrUserData),
                                                  F@_25, TrUserData).

d_field_light_component_parameters_probe_fade(<<0:16, 128, 127, Rest/binary>>, Z1, Z2,
                                              F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                                              F@_10, F@_11, F@_12, F@_13, F@_14, F@_15, F@_16,
                                              F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                              F@_24, _, TrUserData) ->
...
d_field_light_component_parameters_probe_fade(<<0:16, 128, 255, Rest/binary>>, Z1, Z2,
                                              F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                                              F@_10, F@_11, F@_12, F@_13, F@_14, F@_15, F@_16,
                                              F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                              F@_24, _, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  ...
                                                  F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  id('-infinity', TrUserData), TrUserData);
d_field_light_component_parameters_probe_fade(<<_:16, 1:1, _:7, _:1, 127:7, Rest/binary>>,
                                              Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
                                              F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14, F@_15,
                                              F@_16, F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                              F@_23, F@_24, _, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, F@_23, F@_24,
                                                  id(nan, TrUserData), TrUserData);
d_field_light_component_parameters_probe_fade(<<Value:32/little-float, Rest/binary>>, Z1,
                                              Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
...
skip_varint_light_component_parameters(<<1:1, _:7, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                       F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                       F@_12, F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                       F@_20, F@_21, F@_22, F@_23, F@_24, F@_25, TrUserData) ->
    skip_varint_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                           F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                           F@_15, F@_16, F@_17, F@_18, F@_19, F@_20, F@_21, F@_22,
                                           F@_23, F@_24, F@_25, TrUserData);
skip_varint_light_component_parameters(<<0:1, _:7, Rest/binary>>, Z1, Z2, F@_1, F@_2,
                                       F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11,
                                       F@_12, F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                       F@_20, F@_21, F@_22, F@_23, F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
...
skip_length_delimited_light_component_parameters(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1,
                                                 F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                                                 F@_10, F@_11, F@_12, F@_13, F@_14, F@_15, F@_16,
                                                 F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                 F@_24, F@_25, TrUserData)
    when N < 57 ->
    skip_length_delimited_light_component_parameters(Rest, N + 7, X bsl N + Acc, F@_1, F@_2,
                                                     F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                                                     F@_10, F@_11, F@_12, F@_13, F@_14, F@_15,
                                                     F@_16, F@_17, F@_18, F@_19, F@_20, F@_21,
                                                     F@_22, F@_23, F@_24, F@_25, TrUserData);
skip_length_delimited_light_component_parameters(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1,
                                                 F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
                                                 F@_10, F@_11, F@_12, F@_13, F@_14, F@_15, F@_16,
                                                 F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                                 F@_24, F@_25, TrUserData) ->
    ...
    dfp_read_field_def_light_component_parameters(Rest2, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                  TrUserData).

skip_group_light_component_parameters(Bin, FNum, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                      F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14, F@_15,
                                      F@_16, F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23, F@_24,
                                      F@_25, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_light_component_parameters(Rest, 0, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                                  F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12,
                                                  F@_13, F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
                                                  F@_20, F@_21, F@_22, F@_23, F@_24, F@_25,
                                                  TrUserData).

skip_32_light_component_parameters(<<_:32, Rest/binary>>, Z1, Z2, F@_1, F@_2, F@_3, F@_4,
...
skip_64_light_component_parameters(<<_:64, Rest/binary>>, Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                   F@_5, F@_6, F@_7, F@_8, F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
                                   F@_15, F@_16, F@_17, F@_18, F@_19, F@_20, F@_21, F@_22, F@_23,
                                   F@_24, F@_25, TrUserData) ->
    dfp_read_field_def_light_component_parameters(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
        light_component_parameters ->
            merge_msg_light_component_parameters(Prev, New, TrUserData);
        m_entity_id ->
...
merge_msg_light_component_parameters(PMsg, NMsg, TrUserData) ->
    ...
    S3 = case {PMsg, NMsg} of
             {_, #{is_visible := NFis_visible}} ->
                 S2#{is_visible => NFis_visible};
             {#{is_visible := PFis_visible}, _} ->
                 S2#{is_visible => PFis_visible};
             _ ->
                 S2
         end,
    ...
    S5 = case {PMsg, NMsg} of
             {#{color := PFcolor}, #{color := NFcolor}} ->
                 S4#{color => merge_msg_vector_4(PFcolor, NFcolor, TrUserData)};
             {_, #{color := NFcolor}} ->
                 S4#{color => NFcolor};
             {#{color := PFcolor}, _} ->
                 S4#{color => PFcolor};
    ...
    S6 = case {PMsg, NMsg} of
             {_, #{diffuse_multiplier := NFdiffuse_multiplier}} ->
                 S5#{diffuse_multiplier => NFdiffuse_multiplier};
             {#{diffuse_multiplier := PFdiffuse_multiplier}, _} ->
                 S5#{diffuse_multiplier => PFdiffuse_multiplier};
             _ ->
                 S5
         end,
    S7 = case {PMsg, NMsg} of
             {_, #{specular_multiplier := NFspecular_multiplier}} ->
                 S6#{specular_multiplier => NFspecular_multiplier};
             {#{specular_multiplier := PFspecular_multiplier}, _} ->
                 S6#{specular_multiplier => PFspecular_multiplier};
             _ ->
                 S6
         end,
    S8 = case {PMsg, NMsg} of
             {_, #{is_ambiant := NFis_ambiant}} ->
                 S7#{is_ambiant => NFis_ambiant};
             {#{is_ambiant := PFis_ambiant}, _} ->
                 S7#{is_ambiant => PFis_ambiant};
             _ ->
                 S7
         end,
    S9 = case {PMsg, NMsg} of
             {_, #{max_point_distance := NFmax_point_distance}} ->
                 S8#{max_point_distance => NFmax_point_distance};
             {#{max_point_distance := PFmax_point_distance}, _} ->
                 S8#{max_point_distance => PFmax_point_distance};
             _ ->
                 S8
         end,
    S10 = case {PMsg, NMsg} of
              {_, #{'PointAttenuationBulbSize' := NFPointAttenuationBulbSize}} ->
                  S9#{'PointAttenuationBulbSize' => NFPointAttenuationBulbSize};
              {#{'PointAttenuationBulbSize' := PFPointAttenuationBulbSize}, _} ->
                  S9#{'PointAttenuationBulbSize' => PFPointAttenuationBulbSize};
              _ ->
                  S9
          end,
    S11 = case {PMsg, NMsg} of
              {_, #{area_max_distance := NFarea_max_distance}} ->
                  S10#{area_max_distance => NFarea_max_distance};
              {#{area_max_distance := PFarea_max_distance}, _} ->
                  S10#{area_max_distance => PFarea_max_distance};
              _ ->
                  S10
          end,
    S12 = case {PMsg, NMsg} of
              {_, #{area_width := NFarea_width}} ->
                  S11#{area_width => NFarea_width};
              {#{area_width := PFarea_width}, _} ->
                  S11#{area_width => PFarea_width};
              _ ->
                  S11
          end,
    S13 = case {PMsg, NMsg} of
              {_, #{area_height := NFarea_height}} ->
                  S12#{area_height => NFarea_height};
              {#{area_height := PFarea_height}, _} ->
                  S12#{area_height => PFarea_height};
              _ ->
                  S12
          end,
    S14 = case {PMsg, NMsg} of
              {_, #{area_fov := NFarea_fov}} ->
                  S13#{area_fov => NFarea_fov};
              {#{area_fov := PFarea_fov}, _} ->
                  S13#{area_fov => PFarea_fov};
              _ ->
                  S13
          end,
    S15 = case {PMsg, NMsg} of
              {_, #{projector_max_distance := NFprojector_max_distance}} ->
                  S14#{projector_max_distance => NFprojector_max_distance};
              {#{projector_max_distance := PFprojector_max_distance}, _} ->
                  S14#{projector_max_distance => PFprojector_max_distance};
              _ ->
                  S14
          end,
    S16 = case {PMsg, NMsg} of
              {_, #{projector_attenuation_bulb_size := NFprojector_attenuation_bulb_size}} ->
                  S15#{projector_attenuation_bulb_size => NFprojector_attenuation_bulb_size};
              {#{projector_attenuation_bulb_size := PFprojector_attenuation_bulb_size}, _} ->
                  S15#{projector_attenuation_bulb_size => PFprojector_attenuation_bulb_size};
              _ ->
                  S15
          end,
    S17 = case {PMsg, NMsg} of
              {_, #{projector_fov := NFprojector_fov}} ->
                  S16#{projector_fov => NFprojector_fov};
              {#{projector_fov := PFprojector_fov}, _} ->
                  S16#{projector_fov => PFprojector_fov};
              _ ->
                  S16
          end,
    S18 = case {PMsg, NMsg} of
              {_, #{projector_near_plane := NFprojector_near_plane}} ->
                  S17#{projector_near_plane => NFprojector_near_plane};
              {#{projector_near_plane := PFprojector_near_plane}, _} ->
                  S17#{projector_near_plane => PFprojector_near_plane};
              _ ->
                  S17
          end,
    S19 = case {PMsg, NMsg} of
              {#{probe_area_dimension := PFprobe_area_dimension},
               #{probe_area_dimension := NFprobe_area_dimension}} ->
                  S18#{probe_area_dimension =>
                           merge_msg_vector_3(PFprobe_area_dimension,
                                              NFprobe_area_dimension,
                                              TrUserData)};
              {_, #{probe_area_dimension := NFprobe_area_dimension}} ->
                  S18#{probe_area_dimension => NFprobe_area_dimension};
              {#{probe_area_dimension := PFprobe_area_dimension}, _} ->
                  S18#{probe_area_dimension => PFprobe_area_dimension};
              {_, _} ->
                  S18
          end,
    S20 = case {PMsg, NMsg} of
              {_, #{probe_sort_priority := NFprobe_sort_priority}} ->
                  S19#{probe_sort_priority => NFprobe_sort_priority};
              {#{probe_sort_priority := PFprobe_sort_priority}, _} ->
                  S19#{probe_sort_priority => PFprobe_sort_priority};
              _ ->
                  S19
          end,
    S21 = case {PMsg, NMsg} of
              {_, #{probe_box_projected := NFprobe_box_projected}} ->
                  S20#{probe_box_projected => NFprobe_box_projected};
              {#{probe_box_projected := PFprobe_box_projected}, _} ->
                  S20#{probe_box_projected => PFprobe_box_projected};
              _ ->
                  S20
          end,
    S22 = case {PMsg, NMsg} of
              {_, #{probe_box_height := NFprobe_box_height}} ->
                  S21#{probe_box_height => NFprobe_box_height};
              {#{probe_box_height := PFprobe_box_height}, _} ->
                  S21#{probe_box_height => PFprobe_box_height};
              _ ->
                  S21
          end,
    S23 = case {PMsg, NMsg} of
              {_, #{probe_box_length := NFprobe_box_length}} ->
                  S22#{probe_box_length => NFprobe_box_length};
              {#{probe_box_length := PFprobe_box_length}, _} ->
                  S22#{probe_box_length => PFprobe_box_length};
              _ ->
                  S22
          end,
    S24 = case {PMsg, NMsg} of
              {_, #{probe_box_width := NFprobe_box_width}} ->
                  S23#{probe_box_width => NFprobe_box_width};
              {#{probe_box_width := PFprobe_box_width}, _} ->
                  S23#{probe_box_width => PFprobe_box_width};
              _ ->
                  S23
          end,
    S25 = case {PMsg, NMsg} of
              {_, #{attenuation_falloff := NFattenuation_falloff}} ->
                  S24#{attenuation_falloff => NFattenuation_falloff};
              {#{attenuation_falloff := PFattenuation_falloff}, _} ->
                  S24#{attenuation_falloff => PFattenuation_falloff};
              _ ->
                  S24
          end,
    case {PMsg, NMsg} of
        {_, #{probe_fade := NFprobe_fade}} ->
            S25#{probe_fade => NFprobe_fade};
        {#{probe_fade := PFprobe_fade}, _} ->
            S25#{probe_fade => PFprobe_fade};
        _ ->
            S25
    end.
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        light_component_parameters ->
            v_msg_light_component_parameters(Msg, [MsgName], TrUserData);
        m_entity_id ->
...
v_msg_light_component_parameters(#{} = M, Path, TrUserData) ->
    ...
    case M of
        #{is_visible := F2} ->
            v_type_bool(F2, [is_visible | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{is_on := F3} ->
            v_type_bool(F3, [is_on | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{color := F4} ->
            v_msg_vector_4(F4, [color | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{diffuse_multiplier := F5} ->
            v_type_float(F5, [diffuse_multiplier | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{specular_multiplier := F6} ->
            v_type_float(F6, [specular_multiplier | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{is_ambiant := F7} ->
            v_type_bool(F7, [is_ambiant | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{max_point_distance := F8} ->
            v_type_float(F8, [max_point_distance | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{'PointAttenuationBulbSize' := F9} ->
            v_type_float(F9, ['PointAttenuationBulbSize' | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{area_max_distance := F10} ->
            v_type_float(F10, [area_max_distance | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{area_width := F11} ->
            v_type_float(F11, [area_width | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{area_height := F12} ->
            v_type_float(F12, [area_height | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{area_fov := F13} ->
            v_type_float(F13, [area_fov | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{projector_max_distance := F14} ->
            v_type_float(F14, [projector_max_distance | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{projector_attenuation_bulb_size := F15} ->
            v_type_float(F15, [projector_attenuation_bulb_size | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{projector_fov := F16} ->
            v_type_float(F16, [projector_fov | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{projector_near_plane := F17} ->
            v_type_float(F17, [projector_near_plane | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{probe_area_dimension := F18} ->
            v_msg_vector_3(F18, [probe_area_dimension | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{probe_sort_priority := F19} ->
            v_type_uint32(F19, [probe_sort_priority | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{probe_box_projected := F20} ->
            v_type_bool(F20, [probe_box_projected | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{probe_box_height := F21} ->
            v_type_float(F21, [probe_box_height | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{probe_box_length := F22} ->
            v_type_float(F22, [probe_box_length | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{probe_box_width := F23} ->
            v_type_float(F23, [probe_box_width | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{attenuation_falloff := F24} ->
            v_type_float(F24, [attenuation_falloff | Path], TrUserData);
        _ ->
            ok
    end,
    case M of
        #{probe_fade := F25} ->
            v_type_float(F25, [probe_fade | Path], TrUserData);
        _ ->
            ok
    end,
    lists:foreach(fun (entity_id) ->
                      ...
                      (area_fov) ->
                          ok;
                      (projector_max_distance) ->
                          ok;
                      (projector_attenuation_bulb_size) ->
                          ok;
                      (projector_fov) ->
                          ok;
                      (projector_near_plane) ->
                          ok;
                      (probe_area_dimension) ->
                          ok;
                      (probe_sort_priority) ->
                          ok;
                      (probe_box_projected) ->
                  ...
                  maps:keys(M)),
    ok;
v_msg_light_component_parameters(M, Path, _TrUserData) when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M), light_component_parameters}, M, Path);
v_msg_light_component_parameters(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, light_component_parameters}, X, Path).
     ...
     {{msg, light_component_parameters},
      [#{name => entity_id,
       ...
       #{name => color,
         ...
         occurrence => optional,
         opts => []},
       #{name => diffuse_multiplier,
         fnum => 5,
         rnum => 6,
         type => float,
         occurrence => optional,
         opts => []},
       #{name => specular_multiplier,
         fnum => 6,
         rnum => 7,
         type => float,
         occurrence => optional,
       ...
       #{name => is_ambiant,
         ...
         occurrence => optional,
         opts => []},
       #{name => max_point_distance,
         fnum => 8,
         rnum => 9,
         type => float,
         occurrence => optional,
         opts => []},
       #{name => 'PointAttenuationBulbSize',
         fnum => 9,
         rnum => 10,
         type => float,
         occurrence => optional,
         opts => []},
       #{name => area_max_distance,
         fnum => 10,
         rnum => 11,
         type => float,
         occurrence => optional,
       ...
       #{name => area_fov,
         ...
         occurrence => optional,
         opts => []},
       #{name => projector_max_distance,
         fnum => 14,
         rnum => 15,
         type => float,
         occurrence => optional,
         opts => []},
       #{name => projector_attenuation_bulb_size,
         fnum => 15,
         rnum => 16,
         type => float,
         occurrence => optional,
       ...
       #{name => projector_fov,
         ...
         occurrence => optional,
         opts => []},
       #{name => projector_near_plane,
         fnum => 17,
         rnum => 18,
         type => float,
         occurrence => optional,
         opts => []},
       #{name => probe_area_dimension,
         fnum => 18,
         rnum => 19,
         type => {msg, vector_3},
         occurrence => optional,
         opts => []},
       #{name => probe_sort_priority,
         fnum => 19,
         rnum => 20,
         type => uint32,
         occurrence => optional,
         opts => []},
       #{name => probe_box_projected,
         fnum => 20,
         rnum => 21,
         type => bool,
         occurrence => optional,
         opts => []},
       #{name => probe_box_height,
         fnum => 21,
         rnum => 22,
         type => float,
         occurrence => optional,
         opts => []},
       #{name => probe_box_length,
         fnum => 22,
         rnum => 23,
         type => float,
         occurrence => optional,
         opts => []},
       #{name => probe_box_width,
         fnum => 23,
         rnum => 24,
         type => float,
         occurrence => optional,
         opts => []},
       #{name => attenuation_falloff,
         fnum => 24,
         rnum => 25,
         type => float,
         occurrence => optional,
...
get_msg_names() ->
    [light_component_parameters, m_entity_id, generic_result_code, vector_3, vector_4].
...
get_service_def('eGem.light_service') ->
    {{service, 'eGem.light_service'},
     [#{name => add_light_component,
        input => light_component_parameters,
        output => generic_result_code,
        input_stream => false,
        output_stream => false,
        opts => []},
      #{name => remove_light_components,
        input => m_entity_id,
        output => generic_result_code,
        input_stream => false,
        output_stream => false,
...
get_rpc_names('eGem.light_service') ->
    [add_light_component, remove_light_components, update_light_status];
get_rpc_names(_) ->
    error.

find_rpc_def('eGem.light_service', RpcName) ->
    'find_rpc_def_eGem.light_service'(RpcName);
find_rpc_def(_, _) ->
    error.

'find_rpc_def_eGem.light_service'(add_light_component) ->
    #{name => add_light_component,
      input => light_component_parameters,
      output => generic_result_code,
      input_stream => false,
      output_stream => false,
      opts => []};
'find_rpc_def_eGem.light_service'(remove_light_components) ->
    #{name => remove_light_components,
      input => m_entity_id,
      output => generic_result_code,
      input_stream => false,
      output_stream => false,
      opts => []};
'find_rpc_def_eGem.light_service'(update_light_status) ->
    #{name => update_light_status,
      input => light_component_parameters,
      output => generic_result_code,
      input_stream => false,
      output_stream => false,
      opts => []};
'find_rpc_def_eGem.light_service'(_) ->
    error.
...
fqbin_to_service_name(<<"eGem.light_service">>) ->
    'eGem.light_service';
...
service_name_to_fqbin('eGem.light_service') ->
    <<"eGem.light_service">>;
...
%% name, as atoms.
fqbins_to_service_and_rpc_name(<<"eGem.light_service">>, <<"add_light_component">>) ->
    {'eGem.light_service', add_light_component};
fqbins_to_service_and_rpc_name(<<"eGem.light_service">>, <<"remove_light_components">>) ->
    {'eGem.light_service', remove_light_components};
fqbins_to_service_and_rpc_name(<<"eGem.light_service">>, <<"update_light_status">>) ->
...
service_and_rpc_name_to_fqbins('eGem.light_service', add_light_component) ->
    {<<"eGem.light_service">>, <<"add_light_component">>};
service_and_rpc_name_to_fqbins('eGem.light_service', remove_light_components) ->
    {<<"eGem.light_service">>, <<"remove_light_components">>};
service_and_rpc_name_to_fqbins('eGem.light_service', update_light_status) ->
    {<<"eGem.light_service">>, <<"update_light_status">>};
service_and_rpc_name_to_fqbins(S, R) ->
    error({gpb_error, {badservice_or_rpc, {S, R}}}).

fqbin_to_msg_name(<<"eGem.light_component_parameters">>) ->
    light_component_parameters;
...
msg_name_to_fqbin(light_component_parameters) ->
...
get_all_source_basenames() ->
    ["light_service.proto", "global_defs.proto"].
...
%% functions.
get_all_proto_names() ->
    ["light_service", "global_defs"].

get_msg_containment("light_service") ->
    [light_component_parameters];
...
get_pkg_containment("light_service") ->
    eGem;
...
get_service_containment("light_service") ->
    ['eGem.light_service'];
...
get_rpc_containment("light_service") ->
    [{'eGem.light_service', add_light_component},
     {'eGem.light_service', remove_light_components},
     {'eGem.light_service', update_light_status}];
...
get_proto_by_msg_name_as_fqbin(<<"eGem.vector3">>) ->
    "global_defs";
get_proto_by_msg_name_as_fqbin(<<"eGem.light_component_parameters">>) ->
    "light_service";
...
get_proto_by_service_name_as_fqbin(<<"eGem.light_service">>) ->
    "light_service";
