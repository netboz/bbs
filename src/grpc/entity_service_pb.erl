...
-type create_entity_params() ::
      #{name                    => iodata(),        % = 1
        entity_id               => non_neg_integer(), % = 2, 64 bits
        initial_position        => vector_3(),      % = 3
        activate                => boolean() | 0 | 1 % = 4
       }.

-type entity_creation_result() ::
      #{result_code             => generic_result_code(), % = 1
        entity_id               => non_neg_integer() % = 2, 64 bits
       }.
...
-export_type(['create_entity_params'/0, 'entity_creation_result'/0, 'm_entity_id'/0, 'generic_result_code'/0, 'vector_3'/0, 'vector_4'/0]).

-spec encode_msg(create_entity_params() | entity_creation_result() | m_entity_id() | generic_result_code() | vector_3() | vector_4(), atom()) -> binary().
encode_msg(Msg, MsgName) when is_atom(MsgName) -> encode_msg(Msg, MsgName, []).

-spec encode_msg(create_entity_params() | entity_creation_result() | m_entity_id() | generic_result_code() | vector_3() | vector_4(), atom(), list()) -> binary().
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      create_entity_params -> encode_msg_create_entity_params(id(Msg, TrUserData), TrUserData);
      entity_creation_result -> encode_msg_entity_creation_result(id(Msg, TrUserData), TrUserData);
...
encode_msg_create_entity_params(Msg, TrUserData) -> encode_msg_create_entity_params(Msg, <<>>, TrUserData).


encode_msg_create_entity_params(#{} = M, Bin, TrUserData) ->
    B1 = case M of
	   #{name := F1} ->
	       begin
    ...
    B3 = case M of
	   #{initial_position := F3} ->
		 ...
		 if TrF3 =:= undefined -> B2;
		    true -> e_mfield_create_entity_params_initial_position(TrF3, <<B2/binary, 26>>, TrUserData)
		 end
	       end;
	   _ -> B2
	 end,
...
encode_msg_entity_creation_result(Msg, TrUserData) -> encode_msg_entity_creation_result(Msg, <<>>, TrUserData).


encode_msg_entity_creation_result(#{} = M, Bin, TrUserData) ->
    B1 = case M of
	   #{result_code := F1} ->
	       begin
		 TrF1 = id(F1, TrUserData),
		 if TrF1 =:= undefined -> Bin;
		    true -> e_mfield_entity_creation_result_result_code(TrF1, <<Bin/binary, 10>>, TrUserData)
		 end
	       end;
	   _ -> Bin
	 end,
...
e_mfield_create_entity_params_initial_position(Msg, Bin, TrUserData) -> SubBin = encode_msg_vector_3(Msg, <<>>, TrUserData), Bin2 = e_varint(byte_size(SubBin), Bin), <<Bin2/binary, SubBin/binary>>.

e_mfield_entity_creation_result_result_code(Msg, Bin, TrUserData) -> SubBin = encode_msg_generic_result_code(Msg, <<>>, TrUserData), Bin2 = e_varint(byte_size(SubBin), Bin), <<Bin2/binary, SubBin/binary>>.
...
decode_msg_2_doit(create_entity_params, Bin, TrUserData) -> id(decode_msg_create_entity_params(Bin, TrUserData), TrUserData);
decode_msg_2_doit(entity_creation_result, Bin, TrUserData) -> id(decode_msg_entity_creation_result(Bin, TrUserData), TrUserData);
...
decode_msg_create_entity_params(Bin, TrUserData) -> dfp_read_field_def_create_entity_params(Bin, 0, 0, id(<<>>, TrUserData), id(0, TrUserData), id('$undef', TrUserData), id(false, TrUserData), TrUserData).

dfp_read_field_def_create_entity_params(<<10, Rest/binary>>, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) -> d_field_create_entity_params_name(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_create_entity_params(<<16, Rest/binary>>, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) -> d_field_create_entity_params_entity_id(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_create_entity_params(<<26, Rest/binary>>, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) -> d_field_create_entity_params_initial_position(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_create_entity_params(<<32, Rest/binary>>, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) -> d_field_create_entity_params_activate(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData);
dfp_read_field_def_create_entity_params(<<>>, 0, 0, F@_1, F@_2, F@_3, F@_4, _) ->
    S1 = #{name => F@_1, entity_id => F@_2, activate => F@_4},
    if F@_3 == '$undef' -> S1;
       true -> S1#{initial_position => F@_3}
    end;
dfp_read_field_def_create_entity_params(Other, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) -> dg_read_field_def_create_entity_params(Other, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData).

dg_read_field_def_create_entity_params(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData) when N < 32 - 7 -> dg_read_field_def_create_entity_params(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, TrUserData);
dg_read_field_def_create_entity_params(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 -> d_field_create_entity_params_name(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, TrUserData);
      16 -> d_field_create_entity_params_entity_id(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, TrUserData);
      26 -> d_field_create_entity_params_initial_position(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, TrUserData);
      32 -> d_field_create_entity_params_activate(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, TrUserData);
      _ ->
	  case Key band 7 of
	    0 -> skip_varint_create_entity_params(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, TrUserData);
	    1 -> skip_64_create_entity_params(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, TrUserData);
	    2 -> skip_length_delimited_create_entity_params(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, TrUserData);
	    3 -> skip_group_create_entity_params(Rest, Key bsr 3, 0, F@_1, F@_2, F@_3, F@_4, TrUserData);
	    5 -> skip_32_create_entity_params(Rest, 0, 0, F@_1, F@_2, F@_3, F@_4, TrUserData)
	  end
    end;
dg_read_field_def_create_entity_params(<<>>, 0, 0, F@_1, F@_2, F@_3, F@_4, _) ->
    S1 = #{name => F@_1, entity_id => F@_2, activate => F@_4},
    if F@_3 == '$undef' -> S1;
       true -> S1#{initial_position => F@_3}
    end.

d_field_create_entity_params_name(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData) when N < 57 -> d_field_create_entity_params_name(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_create_entity_params_name(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_2, F@_3, F@_4, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, {id(binary:copy(Bytes), TrUserData), Rest2} end, dfp_read_field_def_create_entity_params(RestF, 0, 0, NewFValue, F@_2, F@_3, F@_4, TrUserData).

d_field_create_entity_params_entity_id(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData) when N < 57 -> d_field_create_entity_params_entity_id(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_create_entity_params_entity_id(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, _, F@_3, F@_4, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData), Rest}, dfp_read_field_def_create_entity_params(RestF, 0, 0, F@_1, NewFValue, F@_3, F@_4, TrUserData).

d_field_create_entity_params_initial_position(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData) when N < 57 -> d_field_create_entity_params_initial_position(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_create_entity_params_initial_position(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, Prev, F@_4, TrUserData) ->
    ...
    dfp_read_field_def_create_entity_params(RestF, 0, 0, F@_1, F@_2,
					    if Prev == '$undef' -> NewFValue;
					       true -> merge_msg_vector_3(Prev, NewFValue, TrUserData)
					    end,
					    F@_4, TrUserData).

d_field_create_entity_params_activate(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData) when N < 57 -> d_field_create_entity_params_activate(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, TrUserData);
d_field_create_entity_params_activate(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, F@_3, _, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0, TrUserData), Rest}, dfp_read_field_def_create_entity_params(RestF, 0, 0, F@_1, F@_2, F@_3, NewFValue, TrUserData).

skip_varint_create_entity_params(<<1:1, _:7, Rest/binary>>, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) -> skip_varint_create_entity_params(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData);
skip_varint_create_entity_params(<<0:1, _:7, Rest/binary>>, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) -> dfp_read_field_def_create_entity_params(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData).

skip_length_delimited_create_entity_params(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData) when N < 57 -> skip_length_delimited_create_entity_params(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, TrUserData);
skip_length_delimited_create_entity_params(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_create_entity_params(Rest2, 0, 0, F@_1, F@_2, F@_3, F@_4, TrUserData).

skip_group_create_entity_params(Bin, FNum, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_create_entity_params(Rest, 0, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData).

skip_32_create_entity_params(<<_:32, Rest/binary>>, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) -> dfp_read_field_def_create_entity_params(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData).

skip_64_create_entity_params(<<_:64, Rest/binary>>, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) -> dfp_read_field_def_create_entity_params(Rest, Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData).

decode_msg_entity_creation_result(Bin, TrUserData) -> dfp_read_field_def_entity_creation_result(Bin, 0, 0, id('$undef', TrUserData), id(0, TrUserData), TrUserData).

dfp_read_field_def_entity_creation_result(<<10, Rest/binary>>, Z1, Z2, F@_1, F@_2, TrUserData) -> d_field_entity_creation_result_result_code(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
dfp_read_field_def_entity_creation_result(<<16, Rest/binary>>, Z1, Z2, F@_1, F@_2, TrUserData) -> d_field_entity_creation_result_entity_id(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
dfp_read_field_def_entity_creation_result(<<>>, 0, 0, F@_1, F@_2, _) ->
    S1 = #{entity_id => F@_2},
    if F@_1 == '$undef' -> S1;
       true -> S1#{result_code => F@_1}
    end;
dfp_read_field_def_entity_creation_result(Other, Z1, Z2, F@_1, F@_2, TrUserData) -> dg_read_field_def_entity_creation_result(Other, Z1, Z2, F@_1, F@_2, TrUserData).

dg_read_field_def_entity_creation_result(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, TrUserData) when N < 32 - 7 -> dg_read_field_def_entity_creation_result(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_entity_creation_result(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 -> d_field_entity_creation_result_result_code(Rest, 0, 0, F@_1, F@_2, TrUserData);
      16 -> d_field_entity_creation_result_entity_id(Rest, 0, 0, F@_1, F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 -> skip_varint_entity_creation_result(Rest, 0, 0, F@_1, F@_2, TrUserData);
	    1 -> skip_64_entity_creation_result(Rest, 0, 0, F@_1, F@_2, TrUserData);
	    2 -> skip_length_delimited_entity_creation_result(Rest, 0, 0, F@_1, F@_2, TrUserData);
	    3 -> skip_group_entity_creation_result(Rest, Key bsr 3, 0, F@_1, F@_2, TrUserData);
	    5 -> skip_32_entity_creation_result(Rest, 0, 0, F@_1, F@_2, TrUserData)
	  end
    end;
dg_read_field_def_entity_creation_result(<<>>, 0, 0, F@_1, F@_2, _) ->
    S1 = #{entity_id => F@_2},
    if F@_1 == '$undef' -> S1;
       true -> S1#{result_code => F@_1}
    end.

d_field_entity_creation_result_result_code(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, TrUserData) when N < 57 -> d_field_entity_creation_result_result_code(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_entity_creation_result_result_code(<<0:1, X:7, Rest/binary>>, N, Acc, Prev, F@_2, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bs:Len/binary, Rest2/binary>> = Rest, {id(decode_msg_generic_result_code(Bs, TrUserData), TrUserData), Rest2} end,
    dfp_read_field_def_entity_creation_result(RestF, 0, 0,
					      if Prev == '$undef' -> NewFValue;
						 true -> merge_msg_generic_result_code(Prev, NewFValue, TrUserData)
					      end,
					      F@_2, TrUserData).

d_field_entity_creation_result_entity_id(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, TrUserData) when N < 57 -> d_field_entity_creation_result_entity_id(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_entity_creation_result_entity_id(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, _, TrUserData) -> {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData), Rest}, dfp_read_field_def_entity_creation_result(RestF, 0, 0, F@_1, NewFValue, TrUserData).

skip_varint_entity_creation_result(<<1:1, _:7, Rest/binary>>, Z1, Z2, F@_1, F@_2, TrUserData) -> skip_varint_entity_creation_result(Rest, Z1, Z2, F@_1, F@_2, TrUserData);
skip_varint_entity_creation_result(<<0:1, _:7, Rest/binary>>, Z1, Z2, F@_1, F@_2, TrUserData) -> dfp_read_field_def_entity_creation_result(Rest, Z1, Z2, F@_1, F@_2, TrUserData).

skip_length_delimited_entity_creation_result(<<1:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, TrUserData) when N < 57 -> skip_length_delimited_entity_creation_result(Rest, N + 7, X bsl N + Acc, F@_1, F@_2, TrUserData);
skip_length_delimited_entity_creation_result(<<0:1, X:7, Rest/binary>>, N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc, <<_:Length/binary, Rest2/binary>> = Rest, dfp_read_field_def_entity_creation_result(Rest2, 0, 0, F@_1, F@_2, TrUserData).

skip_group_entity_creation_result(Bin, FNum, Z2, F@_1, F@_2, TrUserData) -> {_, Rest} = read_group(Bin, FNum), dfp_read_field_def_entity_creation_result(Rest, 0, Z2, F@_1, F@_2, TrUserData).

skip_32_entity_creation_result(<<_:32, Rest/binary>>, Z1, Z2, F@_1, F@_2, TrUserData) -> dfp_read_field_def_entity_creation_result(Rest, Z1, Z2, F@_1, F@_2, TrUserData).

skip_64_entity_creation_result(<<_:64, Rest/binary>>, Z1, Z2, F@_1, F@_2, TrUserData) -> dfp_read_field_def_entity_creation_result(Rest, Z1, Z2, F@_1, F@_2, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    TrUserData = proplists:get_value(user_data, Opts),
    case MsgName of
      create_entity_params -> merge_msg_create_entity_params(Prev, New, TrUserData);
      entity_creation_result -> merge_msg_entity_creation_result(Prev, New, TrUserData);
...
-compile({nowarn_unused_function,merge_msg_create_entity_params/3}).
merge_msg_create_entity_params(PMsg, NMsg, TrUserData) ->
    S1 = #{},
    ...
    S3 = case {PMsg, NMsg} of
	   {_, #{entity_id := NFentity_id}} -> S2#{entity_id => NFentity_id};
	   {#{entity_id := PFentity_id}, _} -> S2#{entity_id => PFentity_id};
	   _ -> S2
	 end,
    S4 = case {PMsg, NMsg} of
	   {#{initial_position := PFinitial_position}, #{initial_position := NFinitial_position}} -> S3#{initial_position => merge_msg_vector_3(PFinitial_position, NFinitial_position, TrUserData)};
	   {_, #{initial_position := NFinitial_position}} -> S3#{initial_position => NFinitial_position};
	   {#{initial_position := PFinitial_position}, _} -> S3#{initial_position => PFinitial_position};
	   {_, _} -> S3
	 end,
    case {PMsg, NMsg} of
      {_, #{activate := NFactivate}} -> S4#{activate => NFactivate};
      {#{activate := PFactivate}, _} -> S4#{activate => PFactivate};
      _ -> S4
    end.

-compile({nowarn_unused_function,merge_msg_entity_creation_result/3}).
merge_msg_entity_creation_result(PMsg, NMsg, TrUserData) ->
    S1 = #{},
    S2 = case {PMsg, NMsg} of
	   {#{result_code := PFresult_code}, #{result_code := NFresult_code}} -> S1#{result_code => merge_msg_generic_result_code(PFresult_code, NFresult_code, TrUserData)};
...
verify_msg(Msg, MsgName, Opts) ->
    TrUserData = proplists:get_value(user_data, Opts),
    case MsgName of
      create_entity_params -> v_msg_create_entity_params(Msg, [MsgName], TrUserData);
      entity_creation_result -> v_msg_entity_creation_result(Msg, [MsgName], TrUserData);
...
-compile({nowarn_unused_function,v_msg_create_entity_params/3}).
-dialyzer({nowarn_function,v_msg_create_entity_params/3}).
v_msg_create_entity_params(#{} = M, Path, TrUserData) ->
    case M of
      #{name := F1} -> v_type_string(F1, [name | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{entity_id := F2} -> v_type_uint64(F2, [entity_id | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{initial_position := F3} -> v_msg_vector_3(F3, [initial_position | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{activate := F4} -> v_type_bool(F4, [activate | Path], TrUserData);
      _ -> ok
    end,
    lists:foreach(fun (name) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_create_entity_params(M, Path, _TrUserData) when is_map(M) -> mk_type_error({missing_fields, [] -- maps:keys(M), create_entity_params}, M, Path);
v_msg_create_entity_params(X, Path, _TrUserData) -> mk_type_error({expected_msg, create_entity_params}, X, Path).

-compile({nowarn_unused_function,v_msg_entity_creation_result/3}).
-dialyzer({nowarn_function,v_msg_entity_creation_result/3}).
v_msg_entity_creation_result(#{} = M, Path, TrUserData) ->
    case M of
      #{result_code := F1} -> v_msg_generic_result_code(F1, [result_code | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{entity_id := F2} -> v_type_uint64(F2, [entity_id | Path], TrUserData);
    ...
    lists:foreach(fun (result_code) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_entity_creation_result(M, Path, _TrUserData) when is_map(M) -> mk_type_error({missing_fields, [] -- maps:keys(M), entity_creation_result}, M, Path);
v_msg_entity_creation_result(X, Path, _TrUserData) -> mk_type_error({expected_msg, entity_creation_result}, X, Path).
...
get_msg_defs() ->
    [{{enum, 'generic_result_code.enum_generic_result_code'}, [{ok, 0}, {failed, 1}, {not_found, 2}, {invalid_parameter, 3}, {unimplemented, 4}, {deactivate_first, 5}, {activate_first, 6}, {entity_not_initialised, 7}, {component_already_exists, 8}]},
     {{msg, create_entity_params},
      [#{name => name, fnum => 1, rnum => 2, type => string, occurrence => optional, opts => []}, #{name => entity_id, fnum => 2, rnum => 3, type => uint64, occurrence => optional, opts => []},
       #{name => initial_position, fnum => 3, rnum => 4, type => {msg, vector_3}, occurrence => optional, opts => []}, #{name => activate, fnum => 4, rnum => 5, type => bool, occurrence => optional, opts => []}]},
     {{msg, entity_creation_result}, [#{name => result_code, fnum => 1, rnum => 2, type => {msg, generic_result_code}, occurrence => optional, opts => []}, #{name => entity_id, fnum => 2, rnum => 3, type => uint64, occurrence => optional, opts => []}]},
...
get_msg_names() -> [create_entity_params, entity_creation_result, m_entity_id, generic_result_code, vector_3, vector_4].


get_group_names() -> [].


get_msg_or_group_names() -> [create_entity_params, entity_creation_result, m_entity_id, generic_result_code, vector_3, vector_4].
...
find_msg_def(create_entity_params) ->
    [#{name => name, fnum => 1, rnum => 2, type => string, occurrence => optional, opts => []}, #{name => entity_id, fnum => 2, rnum => 3, type => uint64, occurrence => optional, opts => []},
     #{name => initial_position, fnum => 3, rnum => 4, type => {msg, vector_3}, occurrence => optional, opts => []}, #{name => activate, fnum => 4, rnum => 5, type => bool, occurrence => optional, opts => []}];
find_msg_def(entity_creation_result) ->
    [#{name => result_code, fnum => 1, rnum => 2, type => {msg, generic_result_code}, occurrence => optional, opts => []}, #{name => entity_id, fnum => 2, rnum => 3, type => uint64, occurrence => optional, opts => []}];
...
get_service_names() -> ['eGem.entity_service'].


get_service_def('eGem.entity_service') ->
    {{service, 'eGem.entity_service'},
     [#{name => create_entity, input => create_entity_params, output => entity_creation_result, input_stream => false, output_stream => false, opts => []},
      #{name => activate_entity, input => m_entity_id, output => generic_result_code, input_stream => false, output_stream => false, opts => []},
      #{name => deactivate_entity, input => m_entity_id, output => generic_result_code, input_stream => false, output_stream => false, opts => []},
      #{name => delete_entity, input => m_entity_id, output => generic_result_code, input_stream => false, output_stream => false, opts => []}]};
get_service_def(_) -> error.


get_rpc_names('eGem.entity_service') -> [create_entity, activate_entity, deactivate_entity, delete_entity];
get_rpc_names(_) -> error.


find_rpc_def('eGem.entity_service', RpcName) -> 'find_rpc_def_eGem.entity_service'(RpcName);
find_rpc_def(_, _) -> error.


'find_rpc_def_eGem.entity_service'(create_entity) -> #{name => create_entity, input => create_entity_params, output => entity_creation_result, input_stream => false, output_stream => false, opts => []};
'find_rpc_def_eGem.entity_service'(activate_entity) -> #{name => activate_entity, input => m_entity_id, output => generic_result_code, input_stream => false, output_stream => false, opts => []};
'find_rpc_def_eGem.entity_service'(deactivate_entity) -> #{name => deactivate_entity, input => m_entity_id, output => generic_result_code, input_stream => false, output_stream => false, opts => []};
'find_rpc_def_eGem.entity_service'(delete_entity) -> #{name => delete_entity, input => m_entity_id, output => generic_result_code, input_stream => false, output_stream => false, opts => []};
'find_rpc_def_eGem.entity_service'(_) -> error.
...
fqbin_to_service_name(<<"eGem.entity_service">>) -> 'eGem.entity_service';
fqbin_to_service_name(X) -> error({gpb_error, {badservice, X}}).


%% Convert a service name as an atom to a fully qualified
%% (ie with package name) name as a binary.
service_name_to_fqbin('eGem.entity_service') -> <<"eGem.entity_service">>;
...
%% name, as atoms.
fqbins_to_service_and_rpc_name(<<"eGem.entity_service">>, <<"create_entity">>) -> {'eGem.entity_service', create_entity};
fqbins_to_service_and_rpc_name(<<"eGem.entity_service">>, <<"activate_entity">>) -> {'eGem.entity_service', activate_entity};
fqbins_to_service_and_rpc_name(<<"eGem.entity_service">>, <<"deactivate_entity">>) -> {'eGem.entity_service', deactivate_entity};
fqbins_to_service_and_rpc_name(<<"eGem.entity_service">>, <<"delete_entity">>) -> {'eGem.entity_service', delete_entity};
...
service_and_rpc_name_to_fqbins('eGem.entity_service', create_entity) -> {<<"eGem.entity_service">>, <<"create_entity">>};
service_and_rpc_name_to_fqbins('eGem.entity_service', activate_entity) -> {<<"eGem.entity_service">>, <<"activate_entity">>};
service_and_rpc_name_to_fqbins('eGem.entity_service', deactivate_entity) -> {<<"eGem.entity_service">>, <<"deactivate_entity">>};
service_and_rpc_name_to_fqbins('eGem.entity_service', delete_entity) -> {<<"eGem.entity_service">>, <<"delete_entity">>};
service_and_rpc_name_to_fqbins(S, R) -> error({gpb_error, {badservice_or_rpc, {S, R}}}).


fqbin_to_msg_name(<<"eGem.create_entity_params">>) -> create_entity_params;
fqbin_to_msg_name(<<"eGem.entity_creation_result">>) -> entity_creation_result;
...
msg_name_to_fqbin(create_entity_params) -> <<"eGem.create_entity_params">>;
msg_name_to_fqbin(entity_creation_result) -> <<"eGem.entity_creation_result">>;
...
source_basename() -> "entity_service.proto".
...
get_all_source_basenames() -> ["entity_service.proto", "global_defs.proto"].
...
%% functions.
get_all_proto_names() -> ["entity_service", "global_defs"].


get_msg_containment("entity_service") -> [create_entity_params, entity_creation_result];
get_msg_containment("global_defs") -> [generic_result_code, m_entity_id, vector_3, vector_4];
get_msg_containment(P) -> error({gpb_error, {badproto, P}}).


get_pkg_containment("entity_service") -> eGem;
get_pkg_containment("global_defs") -> eGem;
get_pkg_containment(P) -> error({gpb_error, {badproto, P}}).


get_service_containment("entity_service") -> ['eGem.entity_service'];
get_service_containment("global_defs") -> [];
get_service_containment(P) -> error({gpb_error, {badproto, P}}).


get_rpc_containment("entity_service") -> [{'eGem.entity_service', create_entity}, {'eGem.entity_service', activate_entity}, {'eGem.entity_service', deactivate_entity}, {'eGem.entity_service', delete_entity}];
get_rpc_containment("global_defs") -> [];
get_rpc_containment(P) -> error({gpb_error, {badproto, P}}).


get_enum_containment("entity_service") -> [];
...
get_proto_by_msg_name_as_fqbin(<<"eGem.create_entity_params">>) -> "entity_service";
get_proto_by_msg_name_as_fqbin(<<"eGem.vector4">>) -> "global_defs";
get_proto_by_msg_name_as_fqbin(<<"eGem.m_entity_id">>) -> "global_defs";
get_proto_by_msg_name_as_fqbin(<<"eGem.entity_creation_result">>) -> "entity_service";
get_proto_by_msg_name_as_fqbin(<<"eGem.generic_result_code">>) -> "global_defs";
get_proto_by_msg_name_as_fqbin(E) -> error({gpb_error, {badmsg, E}}).


get_proto_by_service_name_as_fqbin(<<"eGem.entity_service">>) -> "entity_service";
...
get_protos_by_pkg_name_as_fqbin(<<"eGem">>) -> ["entity_service", "global_defs"];
