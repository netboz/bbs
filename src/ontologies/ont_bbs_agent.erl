...
%% Built in predicates
-export([new_knowledge_base_predicate/3, prolog_interpretation_predicate/3, wait_for_predicate/3]).
...
prolog_interpretation_predicate({_Atom, PrologString, PrologTerms}, Next0, #est{bs = Bs, vn = Vn} = St) ->
      ...
      case string_to_eterm(binary_to_list(String) ++ " ") of
        [error, Error] ->
         ...
         Terms ->
          ...
          erlog_int:unify_prove_body(PrologTerms, Goal1, Next0, St#est{bs = NewBs, vn = NewVn })
      end;
    _ ->
