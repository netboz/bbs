...
-export_type(['m_entity_id'/0, 'generic_result_code'/0, 'vector_3'/0, 'vector_4'/0]).

-spec encode_msg(m_entity_id() | generic_result_code() | vector_3() | vector_4(), atom()) -> binary().
encode_msg(Msg, MsgName) when is_atom(MsgName) -> encode_msg(Msg, MsgName, []).

-spec encode_msg(m_entity_id() | generic_result_code() | vector_3() | vector_4(), atom(), list()) -> binary().
...
get_msg_names() -> [m_entity_id, generic_result_code, vector_3, vector_4].


get_group_names() -> [].


get_msg_or_group_names() -> [m_entity_id, generic_result_code, vector_3, vector_4].
...
source_basename() -> "global_defs.proto".
...
get_all_source_basenames() -> ["global_defs.proto"].
...
%% functions.
get_all_proto_names() -> ["global_defs"].
...
get_protos_by_pkg_name_as_fqbin(<<"eGem">>) -> ["global_defs"];
