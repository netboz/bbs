...
-spec add_camera_component(camera_service_pb:camera_component_parameters()) ->
                              {ok, camera_service_pb:generic_result_code(), grpcbox:metadata()} |
                              grpcbox_stream:grpc_error_response() |
                              {error, any()}.
add_camera_component(Input) ->
    add_camera_component(ctx:new(), Input, #{}).

-spec add_camera_component(ctx:t() | camera_service_pb:camera_component_parameters(),
...
-spec add_camera_component(ctx:t(),
                           camera_service_pb:camera_component_parameters(),
                           grpcbox_client:options()) ->
                              {ok, camera_service_pb:generic_result_code(), grpcbox:metadata()} |
                              grpcbox_stream:grpc_error_response() |
...
add_camera_component(Ctx, Input, Options) ->
    grpcbox_client:unary(Ctx,
                         ...
                         Input,
                         ?DEF(camera_component_parameters,
                              generic_result_code,
...
-spec activate_camera_entity(ctx:t() | camera_service_pb:m_entity_id(),
                             camera_service_pb:m_entity_id() | grpcbox_client:options()) ->
                                {ok, camera_service_pb:generic_result_code(), grpcbox:metadata()} |
                                grpcbox_stream:grpc_error_response() |
                                {error, any()}.
...
-spec activate_camera_entity(ctx:t(),
                             camera_service_pb:m_entity_id(),
                             grpcbox_client:options()) ->
                                {ok, camera_service_pb:generic_result_code(), grpcbox:metadata()} |
                                grpcbox_stream:grpc_error_response() |
                                {error, any()}.
