...
-spec add_shape_component(shape_service_pb:add_shape_component_parameters()) ->
    {ok, shape_service_pb:generic_result_code(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
add_shape_component(Input) ->
    add_shape_component(ctx:new(), Input, #{}).

-spec add_shape_component(ctx:t() | shape_service_pb:add_shape_component_parameters(), shape_service_pb:add_shape_component_parameters() | grpcbox_client:options()) ->
    {ok, shape_service_pb:generic_result_code(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec add_shape_component(ctx:t(), shape_service_pb:add_shape_component_parameters(), grpcbox_client:options()) ->
    {ok, shape_service_pb:generic_result_code(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
add_shape_component(Ctx, Input, Options) ->
    grpcbox_client:unary(Ctx, <<"/eGem.shape_service/add_shape_component">>, Input, ?DEF(add_shape_component_parameters, generic_result_code, <<"eGem.add_shape_component_parameters">>), Options).
...
-spec remove_shape_components(ctx:t() | shape_service_pb:m_entity_id(), shape_service_pb:m_entity_id() | grpcbox_client:options()) ->
    {ok, shape_service_pb:generic_result_code(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec remove_shape_components(ctx:t(), shape_service_pb:m_entity_id(), grpcbox_client:options()) ->
    {ok, shape_service_pb:generic_result_code(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
remove_shape_components(Ctx, Input, Options) ->
    grpcbox_client:unary(Ctx, <<"/eGem.shape_service/remove_shape_components">>, Input, ?DEF(m_entity_id, generic_result_code, <<"eGem.m_entity_id">>), Options).
